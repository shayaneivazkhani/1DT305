...
Apart from buying the meaterials needed and the time it take for the delivery and soldering the temprature pins that comes with the Adafruit semsor, this project will not take more than 30 minutes to assemble and program by following the description below.
